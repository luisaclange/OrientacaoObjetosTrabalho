...
public class FrmFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        telafornecedores.setMinimumSize(new java.awt.Dimension(1200, 700));
        telafornecedores.setPreferredSize(new java.awt.Dimension(20000, 20000));
        ...
        consultaLayout.setVerticalGroup(
            ...
            .addGroup(consultaLayout.createSequentialGroup()
                ...
                .addGap(21, 21, 21)
                .addComponent(scrollTabela, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        telafornecedores.add(painelinferior, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 20000, 20000));
        ...
        titulofornecedores.setForeground(letraSecundaria);
        ...
        telafornecedores.add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, 20000, 170));
        ...
        telafornecedores.add(navbar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 250, 20000));
        ...
        telafornecedores.add(painelsuperior, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 0, 20000, 50));
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        if(txtcnpj.getText().equals("  .   .   /    -  ")){//campo cnpj vazio
            msg += "\n CNPJ ";
            lib++;           
        }
        ...
        Fornecedores obj = new Fornecedores();
        Fornecedores limpa = new Fornecedores();
        ...
        if (model.isCNPJ(txtcnpj.getText()) == false) {//Verifica se o CNPJ é Valido se for false...
            ...
            txtcnpj.setText(limpa.getCnpj());//seta null no campo CNPJ
            return;
        } 
    ...
    private void btneditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditarActionPerformed
       ...
       if (txtnumero.getText().equals("")){//se o numero da residencia estiver nulo seta 0
        ...
        if (obj.equalsCnpjId(txtcnpj.getText(), (Integer.parseInt(txtcodigo.getText())))) {// Verifica se o CNPJ já está cadastrado é o mesmo que está no id...
            JOptionPane.showMessageDialog(null, "CNPJ Já Cadastrado");
            txtcnpj.setText(obj.getCnpj());//seta null no campo CNPJ
            return;
        }
